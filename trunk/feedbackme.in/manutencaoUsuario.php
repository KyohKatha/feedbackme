...
class ManutencaoUsuario {
    ...
    public function retornarUsuario($nomeUsuario) {
        $usuario = new Usuario();
        $con = ConexaoBD::getInstance();
        $usuario = $con->retornarUsuario($nomeUsuario);
        return $usuario;
    }
        ...
        if($temp) {
            ...
            switch ($temp) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    self::selecionarUsuario();
                    break;
                case 5:
                    self::adicionarMensagem();
                    break;
                case 6:
                    self::logoff();
                    break;
           ...
           $controle = new ManutencaoUsuario();
           $controle->request($tipo);
