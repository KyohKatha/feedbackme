...
include_once 'manutencaoUsuario.php';
...
<html>
    ...
    if(!empty($_GET["usuario"])){
        $bridge = new ManutencaoUsuario();
        $usuarioSel = $bridge->retornarUsuario($_GET["usuario"]);
    }
    ...
    <body onload="iniciar()">
            ...
            <ul>
                ...
                <li>
                    <table>
                        <tr>
                            <td>
                                <img alt="home" src="imagem/home.png"/>
                            </td>
                            <td>
        ...
        <fieldset class="envioMensagem" >
            <form action="manutencaoUsuario.php" method="post">
                <label>Defina <?php  ?> em 3 palavras!</label><p>
                ...
                <label>Deixe uma mensagem para <?php  ?>!</label>
        ...
        <fieldset class="envioMensagem2" >
             <img src="imagem/notExist.png">
